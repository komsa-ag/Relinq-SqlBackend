...
namespace Remotion.Linq.SqlBackend.SqlStatementModel.SqlSpecificExpressions
{
  ...
  public class SqlBinaryOperatorExpression : Expression
  {
    ...
    public SqlBinaryOperatorExpression(Type type, string binaryOperator, Expression leftExpression, 
    ...
    protected override Expression VisitChildren(ExpressionVisitor visitor)
    {
      ...
      if (newLeftExpression != _leftExpression || newRightExpression != _rightExpression)
        return new SqlBinaryOperatorExpression(Type, _binaryOperator, newLeftExpression, newRightExpression);
      else
        return this;
    }
